application_gateways = {
  agw1 = {
    ...
    subnet_id = "/subscriptions/e22a351f-db36-4a02-9793-0f2189d5f3ab/resourceGroups/gcci-rg-agency-vnets/providers/Microsoft.Network/virtualNetworks/gcci-vnet-internet/subnets/ref1-snet-web-internet"
    ...
    front_end_ip_configurations = {
      ...
      private = {
        name                          = "private"
        # TODO: add subnet_id and subnet_cidr
        # vnet_key                      = "vnet_region1"
        # subnet_key                    = "app-gateway-subnet"
        subnet_id = "/subscriptions/e22a351f-db36-4a02-9793-0f2189d5f3ab/resourceGroups/gcci-rg-agency-vnets/providers/Microsoft.Network/virtualNetworks/gcci-vnet-internet/subnets/ref1-snet-web-internet"
